...
This is a guide that will show you how to write documentation for the [Bazzite operating system](https://bazzite.gg).
...
Translating documentation is as straightfoward as it can be.
